...
Eaach item haas a number in parentheses, that is Karsten's priorities.
...
** (9) Show/Hide side column “taskpane” (what Microsoft calls it).
...
K (1) Insert a “Component” — don’t bother trying to load a whole other Word Document yet. Just
      ...
      it super simple at first, just prepend “component_” to the start of the variable name, and just
...
- (8) Now, lets add ”active”/”hidden”/”flattened” status functionality. On document load,
      ...
      what we currently use. They are simplified for the POC.
        - “active” - display it as usual - editable, clickable, selectable
        - “hidden” - do not display it at all
        - “flattened” - display the content, but not as a component, not interactive, but inline as normal content
